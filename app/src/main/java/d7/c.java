...
public abstract class c extends e {
    ...
    public c(c7.e eVar, int i7, InputStream inputStream, z6.b bVar) throws vi2 {
        super(eVar, i7, inputStream, bVar);
        int iA = d0.a(this.f4656d, 24, 2, d0.a(this.f4655c, 4, 2, 30));
        if (eVar.f3507b == iA) {
            e7.a.c(inputStream);
            e7.a.c(inputStream);
            this.f4654g = new double[this.f4656d];
            for (int i8 = 0; i8 < this.f4656d; i8++) {
                this.f4654g[i8] = e7.a.c(inputStream);
            }
            return;
        }
